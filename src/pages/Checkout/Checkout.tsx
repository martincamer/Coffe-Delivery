	...
	return (
		<Container>
			<div className="left-blocks">
				<SubTitle>completa tu pedido</SubTitle>
				<CheckoutForm>
					<BlockHeader>
						<MapPin
							size={22}
						...
						<div className="block-text">
							<p className="block-title">Dirección de entrega</p>
					...
					<div className="form-inputs">
						...
						{addressViaApi.cep === '' && installmentSelected !== '' ? (
							<span className="error-message-postalcode">Cep Obligatorio</span>
						) : (
							''
						)}
						<CheckoutFormInput
				...
				<Installments>
					<BlockHeader>
						...
						/>
						<div className="block-text">
							<p className="block-title">Pagar</p>
							<p className="block-subtitle">
			...
			<div className="right-blocks">
				<SubTitle>Cafés Seleccionados</SubTitle>
				<OrderSummary>
					<ul
					...
					>
						{productsList.length === 0 ? (
							<>
								<EmptyCartMessage>
									Aún no has añadido cafés a tu carrito.
								</EmptyCartMessage>
								<EmptyCartButton href="/">Escojer mas Cafes</EmptyCartButton>
							</>
						) : (
								...
								return (
									<SelectedProduct key={product.id}>
										...
										<strong className="price">
											ARG$ {formatPrice(product.price * product.quantity)}
										</strong>
									</SelectedProduct>
								);
							})
